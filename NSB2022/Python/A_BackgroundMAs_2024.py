...
ax2.plot(tim, SoS1, 'k', linewidth=1)
...
ax2.plot(tim, RAM, 'k', linewidth=1)
...
PKS, LOCS = find_peaks(np.abs(comboEnv))
ePKS, eLOCS = find_peaks(np.abs(PKS))
...
ax3.plot(tim[LOCS], PKS, 'r.-')
ax3.plot(tim[LOCS[eLOCS]], ePKS, 'go-', linewidth=2, markersize=4)
