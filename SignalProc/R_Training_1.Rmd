...
R does not contain a native function to plot sonograms. In order to plot them we need to use a custom function called **specplot()**. Lets install the dependacies now...
