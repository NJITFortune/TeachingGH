...
Remember to install and import any libraries we will be using:
...
*Note: You may notice that the **collevels** parameter is different in the spectrograms. This parameter specifies the range of colors that will be plotted. Different sequences will give better or worse looking graphs. Go ahead and play with the numbers...remeber the syntax seq(start, end, interval).*

```{r}

spectro(addwav, Fs, wl = 512, 
...
noisy = runif(length(tim), min = 0, max = 10000)
...
```{r}
spectro(noisy, Fs, wl = 512, 
        palette = reverse.heat.colors, 
        collevels = seq(-50, -15, 1), 
        scale = FALSE, 
        main = "Original") 
```
