...
```{r}
revsylsong = syllable[length(syllable)]
```
...
for (l in seq(2, length(syllable), 1)) {
  ...
  ra = syllable[length(syllable)]
  revsylsong = append(revsylsong, unlist(nop[[l]]))
  revsylsong = append(revsylsong, unlist(revsylsong[seq(to = 1, by = -1, length.out =      length(revsylsong))]))
