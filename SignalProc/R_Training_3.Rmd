...
par(mfrow = c(2,4))
spectro(syllable[[4]], Fs, wl = 256, palette = rainbow, collevels = seq(-100, -10, 1), scale = FALSE, ovlp = 90, fftw = TRUE)
spectro(syllable[[5]], Fs, wl = 256, palette = heat.colors, collevels = seq(-100, -10, 1), scale = FALSE, ovlp = 90, fftw = TRUE)
spectro(syllable[[6]], Fs, wl = 256, palette = gray.colors, collevels = seq(-100, -10, 1), scale = FALSE, ovlp = 90, fftw = TRUE)
spectro(syllable[[7]], Fs, wl = 256, palette = rainbow, collevels = seq(-100, -10, 1), scale = FALSE, ovlp = 90, fftw = TRUE)
...
par(mfrow = c(1,2))
spectro(syllable[[7]], Fs, wl = 256, palette = rainbow, collevels = seq(-70, -20, 2), scale = FALSE, ovlp = 95)
plot(timmy[[7]], syllable[[7]], type = "l", col = "Red")
```
